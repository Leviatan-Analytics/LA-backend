...
package com.leviatan.fit.plugins;

import com.leviatan.fit.File;
import com.leviatan.fit.FitListener;
import com.leviatan.fit.MesgBroadcastPlugin;
...
public class ActivityFileValidationPlugin implements MesgBroadcastPlugin {
    ...
    ActivityFileValidationResult checkSessionMesgSport(List<SessionMesg> sessionMesgs) {
        ...
        ActivityFileValidationResult.Status status = checkFieldValuesAreValid(sessionMesgs, "sport");
    ...
    ActivityFileValidationResult checkSessionMesgSubSport(List<SessionMesg> sessionMesgs) {
        ...
        ActivityFileValidationResult.Status status = checkSubSportValuesAreValid(sessionMesgs);
    ...
    ActivityFileValidationResult.Status checkFieldValuesAreValid(List<? extends Mesg> mesgs, String fieldName) {
        ...
        return anyMatchNull(mesgs, fieldName) ? ActivityFileValidationResult.Status.FAILED : ActivityFileValidationResult.Status.PASSED;
    }

    ActivityFileValidationResult.Status checkSportValuesAreValid(List<? extends Mesg> mesgs) {
        ActivityFileValidationResult.Status status = checkFieldValuesAreValid(mesgs, "sport");
    ...
    ActivityFileValidationResult.Status checkSubSportValuesAreValid(List<? extends Mesg> mesgs) {
        ActivityFileValidationResult.Status status = checkFieldValuesAreValid(mesgs, "sub_sport");
        return status == ActivityFileValidationResult.Status.FAILED ? ActivityFileValidationResult.Status.WARNING : status;
    }
}
